              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#585858] text-md xl:text-lg mt-5 font-[500]">
                    ...
                    customers. We ensure seamless performance across all devices
                    and browsers.
                  </p>
                  <p className="mt-4">
                    <Link
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#585858] text-md xl:text-lg mt-5 font-[500]">
                    ...
                    online. We drive traffic, boost visibility, and turn clicks
                    into customers.
                  </p>
                  <p className="mt-4">
                    <Link
            ...
            <div className="group relative w-full bg-white p-6 rounded-lg shadow-md hover:shadow-2xl transition-all duration-500 animate-fade-in-right">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#585858] text-md xl:text-lg mt-5 font-[500]">
                    Visualize your ideas with stunning 3D representations. From
                    product models to architectural designs, we bring concepts
                    to life.
                  </p>
                  <p className="mt-4">
                    <Link
